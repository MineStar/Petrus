...
public class LogoutStatistic {
    ...
    protected LogoutStatistic() {
        // Needed for ormLite
    }

    public LogoutStatistic(String userName, double x, double y, double z, String worldName) {
    ...
    public String toString() {
        return "LoginStatistic [userName=" + userName + ", x=" + x + ", y=" + y + ", z=" + z + ", worldName=" + worldName + ", timestamp=" + timestamp + "]";
    }
